...
BEGIN
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (91%) PRIMARY | 3SL4 (85%) PRIMARY | 3L1 (80%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Cats are better pets than dogs.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Dogs', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Cats', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Why do you think cats are the best pets?
...
Give your final argument for why cats should win this debate.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Ice Cream is better than Pizza', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Ice cream is cold and sweet, and it makes people happy on hot days!', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Pizza has cheese and toppings and can be eaten anytime, unlike ice cream.', NOW(), NOW());
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 7
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (90%) PRIMARY | 3SL4 (85%) PRIMARY | 3L1 (80%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Summer is better than winter.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Winter', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Summer', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'What makes summer so great? Give your best reason.
...
Make your final case: which season wins and why?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 15
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (90%) PRIMARY | 3SL4 (84%) PRIMARY | 3L1 (80%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Pizza is better than tacos.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Tacos', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Pizza', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Start us off — what makes pizza the winner?
...
Wrap it up with your strongest argument for pizza.', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 23
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (89%) PRIMARY | 3SL4 (84%) PRIMARY | 3L1 (79%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Being a morning person is better than being a night owl.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Night', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Morning', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Why is morning the best time of day?
...
Final argument: morning or night — which one wins?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 31
  );
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Books are better than movies.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Movies', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Books', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Make your case for books first.
...
Close it out: what''s your strongest argument?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 39
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (89%) PRIMARY | 3SL4 (83%) PRIMARY | 3L1 (79%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Outdoor recess is better than indoor recess.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Outdoor Recess', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Indoor Recess', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Start by arguing for outdoor recess.
...
Give your final word on which one is better and why.', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 47
  );
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Students should not have homework on weekends.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'No Homework', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Homework', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Why should weekends be homework-free? Build your argument.
...
Is there any homework that would be okay on weekends? Explain, then close your argument.', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 55
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (88%) PRIMARY | 3SL4 (83%) PRIMARY | 3L1 (78%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Students should get 45 minutes for lunch.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Shorter Lunch', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Longer Lunch', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Argue why a longer lunch period is worth it.
...
Wrap up your argument — is the extra time really worth it?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 63
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (88%) PRIMARY | 3SL4 (82%) PRIMARY | 3L1 (78%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Gym class is more important than art class.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Art Class', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Gym Class', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Start your argument — why should gym class win?
...
Give your final statement: which class matters more to a student''s day?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 71
  );
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Crunchy peanut butter is better than smooth.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Smooth Peanut Butter', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Crunchy', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Make the case for crunchy — why is it clearly the winner?
...
Land your strongest argument and declare a winner.', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 79
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (87%) PRIMARY | 3SL4 (82%) PRIMARY | 3L1 (78%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Every classroom should have a class pet.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'No Class Pet', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Class Pet', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Why would a class pet make your classroom better?
...
Make your closing argument — pets in classrooms, yes or no?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 87
  );
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Students should be allowed to stand while working.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Regular Desks', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Stand-Up Desks', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Argue the case for stand-up desks in classrooms.
...
Final thought: should standing be an option in your school?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 95
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (87%) PRIMARY | 3SL4 (81%) PRIMARY | 3L1 (77%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Tablets and computers should be used every day in school.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'No Screens', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Technology in Class', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Build the argument for daily technology use in class.
...
Where do you land? Give your final take on screens in school.', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 103
  );
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Students should wear uniforms to school.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Casual Clothes', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'School Uniforms', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Make the case for school uniforms.
...
Close your argument — uniforms or freedom of choice?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 111
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (86%) PRIMARY | 3SL4 (81%) PRIMARY | 3L1 (77%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'School should only be four days a week.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Five-Day', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Four-Day School Week', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Why would a four-day school week be a great idea?
...
Make your final case — four days or five?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 119
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (87%) PRIMARY | 3SL4 (83%) PRIMARY | 3R9 (78%) SECONDARY | 3L1 (76%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'It is better to finish fast than to slow down and check your work.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Careful', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Fast', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Argue that speed matters — why is finishing fast an advantage?
...
Is there a situation where both could be right? Close with your position.', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 127
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (86%) PRIMARY | 3SL4 (82%) PRIMARY | 3R9 (78%) SECONDARY | 3L1 (76%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Being a good follower is just as important as being a good leader.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Followers', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Leaders', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Make the case that followers are just as valuable as leaders.
...
Final answer: which role matters more, or are they equal?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 135
  );
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Working in a group is better than working alone.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Solo Work', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Group Work', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Build your argument for why group work is superior.
...
Is there a type of task where one is clearly better? Make your closing argument.', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 143
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (86%) PRIMARY | 3SL4 (82%) PRIMARY | 3R9 (77%) SECONDARY | 3L1 (76%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Too many rules make school less fun and less creative.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'No Rules', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Rules', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Argue that fewer rules would make school better.
...
Are any rules absolutely necessary? Close your argument.', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 151
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (85%) PRIMARY | 3SL4 (81%) PRIMARY | 3R9 (77%) SECONDARY | 3L1 (75%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'It is better to try new things than to stick with what you are already good at.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Sticking with What You Know', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Trying New Things', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Make the case for always trying new things.
...
What''s your final position — breadth or depth?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 159
  );
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'You learn more from your mistakes than from your successes.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Learning from Success', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Learning from Mistakes', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Argue that failure teaches more than winning.
...
Give your final verdict — mistakes or success, which teaches more?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 167
  );
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Asking for help is always better than struggling alone.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Figuring It Out Yourself', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Asking for Help', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Argue why asking for help should always be the first move.
...
Final thought: when is each approach the right one?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 175
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (85%) PRIMARY | 3SL4 (80%) PRIMARY | 3R9 (77%) SECONDARY | 3L1 (75%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Hard work matters more than natural talent.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Natural Talent', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Effort', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Make the case that effort always beats natural talent.
...
Land your argument: effort or talent — which one wins in the end?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 183
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (86%) PRIMARY | 3SL4 (82%) PRIMARY | 3R9 (79%) SECONDARY | 3L1 (76%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Being fair and giving everyone the same thing are not always the same idea.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Equality', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Fairness', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Explain the difference between fairness and equality using an example.
...
Give your final argument: which principle should schools follow — equality or fairness?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 191
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (85%) PRIMARY | 3SL4 (82%) PRIMARY | 3R9 (79%) SECONDARY | 3L1 (76%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'When a rule is unfair, you should work to change it rather than just follow it.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Following Them', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Changing the Rules', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Argue that challenging unfair rules is important and necessary.
...
Close with your final take: when should you follow a rule, and when should you work to change it?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 199
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (85%) PRIMARY | 3SL4 (81%) PRIMARY | 3R9 (78%) SECONDARY | 3L1 (75%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'What''s best for the team is more important than what''s best for any single person.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Team', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Individual', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Make the case that the group should always come first.
...
Is there a way to balance both? Give your final position.', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 207
  );
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Understanding something deeply is more valuable than memorizing a lot of facts.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Understanding', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Knowing', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Argue that deep understanding matters more than memorizing many things.
...
Final argument: in school and in life, which one serves you better?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 215
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (84%) PRIMARY | 3SL4 (81%) PRIMARY | 3R9 (78%) SECONDARY | 3L1 (75%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
    'TEACHER', false, false, 3, NULL, 'https://ai-voice-app-audio-storage.s3.us-east-1.amazonaws.com/lesson_images/36.png'
  );
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'It is better to make decisions that help you now than to wait for something better later.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Long-Term Thinking', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Short-Term', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Argue why acting now and getting something good immediately is the smarter approach.
...
Make your final case: short-term satisfaction or long-term planning — which wins?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 223
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (84%) PRIMARY | 3SL4 (80%) PRIMARY | 3R9 (77%) SECONDARY | 3L1 (75%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'It is always better to speak up than to stay silent when something is wrong.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Staying Quiet', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Saying Something', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Argue that speaking up is always the right choice when you see something wrong.
...
Close with your final position: is silence ever the right answer?', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 231
  );
  ...
  INSERT INTO bantrly.lesson (
    ...
    v_lesson_id, 'Silly Topic Debate', '3SL1 (84%) PRIMARY | 3SL4 (80%) PRIMARY | 3R9 (77%) SECONDARY | 3L1 (74%) SECONDARY',
    '8addaf36-3881-49d8-ab34-444c399bf432', 'EASY',
    'Silly Topic Debate'Silly Topic Debate', NOW(), 'ee42009d-d83e-4c12-abd1-2d8fff809b18',
  ...
  INSERT INTO bantrly.lesson_content (content_id, lesson_id, content_key, content_value, created_at, updated_at) VALUES
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'One person speaking clearly and loudly can change things more than a group of people each saying a little.', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Many Small Voices', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'One Strong Voice', NOW(), NOW()),
    (gen_random_uuid(), v_lesson_id, 'Silly Topic Debate', 'Build the case for one strong, focused voice making the most impact.
...
Is the answer different depending on the situation? Give your final answer.', NOW(), NOW()),
  ...
  INSERT INTO bantrly.program_lesson_sequence_new (
    ...
    v_learning_path_id, v_custom_version_id, 'e844d6ae-cbfd-45f9-ba3b-d0b3f1dde266', v_lesson_id,
    'Silly Topic Debate'Silly Topic Debate', 3, NULL, 'EASY', 239
  );
